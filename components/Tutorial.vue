...
<template>
  ...
  >
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div
        class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6 flex flex-col justify-center"
      >
        ...
        <a
          href="https://manascode.com/how-to-deploy-nuxt-ssr-to-digital-ocean-using-docker-compose-and-nginx/"
          target="_blank"
          class="text-center py-4 px-10 bg-green-400 hover:bg-green-600 hover:text-gray-50 mt-5"
        >
          Read more
        </a>
      </div>
